...
public class Calculator {
    ...
    public double calculate() {
        this.operationStrategy.initialization(a, b); // Az adatokat mindenképp el kell juttatni a kiemelt osztályba, mégpedig frissen.

        return this.operationStrategy.calculate();
    }
}